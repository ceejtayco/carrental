						...
						<div class="panel panel-default">
							...
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php $sql = "SELECT location.booking_id, user.FullName, booking.userEmail, vehicle.VehiclesTitle, booking.FromDate, booking.ToDate FROM tbllocation location INNER JOIN tblbooking booking ON location.booking_id = booking.id INNER JOIN tblvehicles vehicle ON booking.VehicleId = vehicle.id INNER JOIN tblusers user ON user.EmailId = booking.userEmail;";
