  ...
  <nav id="navigation_bar" class="navbar navbar-default  <?php $isMobile ? 'fixed-top shadowed' : ''?>" style="<?php echo $navColor ?>">
    <div class="<?php echo $container ?>">
      ...
      if ($isMobile) {
          ...
          echo "
          <span class='navbar-text' style='position:absolute; text-align:center;color:white; left: 37% !important; top: 5px !important; font-weight:600;'>EzRent &nbsp; <i class='fa fa-car fa-sm'></i></span>
          ";
      }
      ?>
...
<p id="session_user_name" style="visibility:hidden;size=0;"><?php echo $_SESSION['login'] ?></p>
<p id="session_user_id" style="visibility:hidden;size=0;"><?php echo $result->id ?></p>
<p id="session_user_type" style="visibility:hidden;size=0;"><?php echo $result->UserType ?></p>
  <?php
    }
   ?>
